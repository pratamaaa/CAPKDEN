...
@section('content')
    ...
    // Menggunakan jQuery untuk Bootstrap 4
    $('#modalStatusAkhir').modal('show')
        .find('#modalStatusAkhirContent')
        .load(`/statuskahirform?userid=${userId}`, function(response, status, xhr) {
            if (status == "error") {
                // Tangani error jika terjadi
                const errorMessage = "Gagal memuat data: " + xhr.status + " " + xhr.statusText;
