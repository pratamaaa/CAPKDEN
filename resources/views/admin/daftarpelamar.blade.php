                                            ...
                                            <div class="card-body table-responsive p-0" style="overflow-x: auto;">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    <thead>
                                                        <tr class="header-row">
                                                            ...
                                                            <th class="align-top text-center" rowspan="2">Calon Kalangan
                                                            </th>
                                                            ...
                                                            <!-- Header Pengusul Calon Kalangan -->
                                                            <th class="align-top text-center" colspan="4">Pengusul Calon
                                                                Kalangan</th>
                                                            <th class="align-top text-center" rowspan="2">Aksi</th>
                                                        </tr>
                                                        <tr class="header-row">
                                                            <!-- Pendidikan -->
                                                            <th class="align-top text-center" style="width: 200px;">Sarjana
                                                            </th>
                                                            <th class="align-top text-center" style="width: 200px;">
                                                                Magister</th>
                                                            <th class="align-top text-center" style="width: 200px;">
                                                                Doktoral</th>
                                                        ...
                                                        @if ($pelamar->count() != 0)
                                                            @foreach ($pelamar->get() as $nourut => $pel)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $pel->kalangan != '' ? $pel->kalangan : '' }}
                                                                    </td>
                                                                    @php
                                                                        $berkaspelamar = Bantuan::berkaspelamar(
                                                                            $pel->user_id,
                                                                        );
                                                                    @endphp
                                                                    <td style="width: 200px;">
                                                ...
                                                <div class="modal fade" id="modalpelamar" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div id="modalpelamar_content"
                                                            class="modal-content shadow rounded-4 border-0"></div>
                                                    </div>
                                                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content shadow rounded-4 border-0">
                    ...
                    <div class="modal-header bg-secondary text-white rounded-top">
                        <img src="{{ asset('bs/dist/img/den.png') }}" alt="Logo DEN"
                            style="width: 36px; height: auto; margin-right: 4px;">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-4 bg-light text-dark text-center py-4 border-end">
                                <img id="previewFoto" src=""
                                    class="img-thumbnail rounded-circle border mb-3 shadow-sm"
                                    style="width: 120px; height: 120px; object-fit: cover;" alt="Foto Profile">
                                <h5 id="previewNama">Nama Lengkap</h5>
                                <p class="text-muted" id="previewKalangan">Kalangan</p>
                                <hr>
                                <div class="text-start px-4 small">
                                    <p><i class="fas fa-id-card me-2 text-muted"></i><strong>NIK</strong><br><span
                                            id="previewNik"></span></p>
                                    <p><i class="fas fa-calendar-alt me-2 text-muted"></i><strong>TTL</strong><br><span
                                            id="previewTtl"></span></p>
                                    <p><i class="fas fa-venus-mars me-2 text-muted"></i><strong>Jenis
                                            Kelamin</strong><br><span id="previewJk"></span></p>
                                    <p><i class="fas fa-phone me-2 text-muted"></i><strong>No. HP</strong><br><span
                                            id="previewHp"></span></p>
                                    <p><i class="fas fa-envelope me-2 text-muted"></i><strong>Email</strong><br><span
                                            id="previewEmail"></span></p>
                                    <p><i
                                            class="fas fa-map-marker-alt me-2 text-muted"></i><strong>Alamat</strong><br><span
                                            id="previewAlamat"></span></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 p-4 bg-light rounded-end">
                                ...
                                <h5 class="mt-5 mb-4 text-primary"><i class="fas fa-users me-2"></i>Pengusul Calon
                                    Kalangan</h5>
                                <div class="table-responsive">
                ...
                document.querySelectorAll(".preview-btn").forEach(button => {
                    button.addEventListener("click", function() {
                        ...
                        document.getElementById("previewNama").innerText =
                            `${gelarDepan} ${nama} ${gelarBelakang}`.replace(/\s+/g, ' ').trim();

                        document.getElementById("previewKalangan").innerText = this.getAttribute(
                            "data-kalangan");
                        ...
                        document.getElementById("previewEmail").innerText = this.getAttribute(
                            "data-email") || 'Belum diisi';

                        document.getElementById("previewAlamat").innerText = this.getAttribute(
                            "data-alamat");
                        document.getElementById("previewFoto").src = this.getAttribute("data-foto");

                        document.getElementById("previewSarjanaUniv").innerText = this.getAttribute(
                            "data-universitas-sarjana");
                        document.getElementById("previewSarjanaJurusan").innerText = this.getAttribute(
                            "data-jurusan-sarjana");
                        document.getElementById("previewSarjanaLulus").innerText = this.getAttribute(
                            "data-lulus-sarjana");

                        document.getElementById("previewMagisterUniv").innerText = this.getAttribute(
                            "data-universitas-magister");
                        document.getElementById("previewMagisterJurusan").innerText = this.getAttribute(
                            "data-jurusan-magister");
                        document.getElementById("previewMagisterLulus").innerText = this.getAttribute(
                            "data-lulus-magister");

                        document.getElementById("previewDoktoralUniv").innerText = this.getAttribute(
                            "data-universitas-doktoral");
                        document.getElementById("previewDoktoralJurusan").innerText = this.getAttribute(
                            "data-jurusan-doktoral");
                        document.getElementById("previewDoktoralLulus").innerText = this.getAttribute(
                            "data-lulus-doktoral");

                        document.getElementById("previewOrgPengusul").innerText = this.getAttribute(
                            "data-org-pengusul");
                        document.getElementById("previewPakar1").innerText = this.getAttribute(
                            "data-rek-pakar1");
                        document.getElementById("previewPakar2").innerText = this.getAttribute(
                            "data-rek-pakar2");
                        document.getElementById("previewPakar3").innerText = this.getAttribute(
                            "data-rek-pakar3");
                    });
                });
            });
