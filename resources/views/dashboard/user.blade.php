                        ...
                        <div class="alert alert-warning d-flex align-items-start gap-3 p-3" role="alert"
                                ...
                                <div>
                                    ...
                                    <ul class="mb-0 ps-3 text-dark">
                                        ...
                                        <li>Cek kembali data yang sudah di upload sebelum melakukan <strong>Submit Data Final</strong> pada menu <strong>Status Berkas</strong>. Jika sudah submit, data yang sudah di input <strong>tidak bisa diubah/ diperbaiki</strong> kembali.</li>
